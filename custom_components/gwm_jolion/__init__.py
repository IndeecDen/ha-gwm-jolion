...
FRONTEND_ASSETS = (
    (
        ...
        "/gwm-jolion/gwm-jolion-card-editor.js?v=0.1.0-alpha.17",
    ),
    (
        FRONTEND_DIR / "gwm-jolion-card.js",
        "/gwm-jolion/gwm-jolion-card.js",
        "/gwm-jolion/gwm-jolion-card.js?v=0.1.0-alpha.17",
    ),
    (
        FRONTEND_DIR / "gwm-jolion-remote-card.js",
        "/gwm-jolion/gwm-jolion-remote-card.js",
        "/gwm-jolion/gwm-jolion-remote-card.js?v=0.1.0-alpha.17",
    ),
)
