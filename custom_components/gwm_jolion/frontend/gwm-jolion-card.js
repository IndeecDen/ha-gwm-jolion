    ...
    _render() {
      ...
      const alerts = [
        doorsOpen
          ...
          : "",
        windowsOpen
          ? this._statusChip("mdi:car-door", "Открыто окно", "danger")
          : "",
        trunkOpen
          ...
          <div class="wrap">
            ...
            <div class="hero">
              ...
              <div class="stats">
                ...
                <div class="stat">
                  ${this._icon("mdi:gauge")}
                  <span>Топливо %</span>
                  <b>${this._escape(this._value("fuelPercent"))}</b>
                </div>
                <div class="stat">
                  ${this._icon("mdi:map-marker-distance")}
                  <span>Запас</span>
                  <b>${this._escape(this._value("range"))}</b>
                </div>
                <div class="stat">
                  ${this._icon("mdi:counter")}
                  <span>Пробег</span>
              ...
              <div class="system">
                ...
                ${
                  this._state("lastCommand")
                    ? `<span>${this._icon("mdi:cloud-check-outline")}${this._escape(this._value("lastCommand"))}</span>`
                    : ""
                }
              </div>
            </div>
