...
(async()=>{
 ...
 try{
  ...
  console.log('Trips card: route, speed colors, parking markers and times, stationary filtering, centering, wheel zoom, touch zoom, dragging, fullscreen, calendar, mobile layout, empty history and errors passed');
