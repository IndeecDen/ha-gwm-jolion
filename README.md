...
Версия **0.1.0-beta.3** · [Изменения](CHANGELOG.md) · [Планы](ROADMAP.md)
...
В блоке **«Подготовка автомобиля»** выберите профиль и нажмите **«Запустить подготовку»**. Доступны редактируемые шаблоны «Зима», «Лето» и «Только водитель».

- **«Настроить»** открывает название, температуру, время двигателя и климата, выбор и мощность сидений, таймер подогрева.
