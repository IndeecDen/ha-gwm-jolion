...
Версия **0.1.0-beta.15** · [Изменения](CHANGELOG.md) · [Планы](ROADMAP.md)
...
Стоянки продолжительностью не менее 10 минут отмечаются отдельной точкой. При наведении показываются время начала и окончания стоянки; если автомобиль ещё не уехал после последней записи, время окончания остаётся неизвестным.
