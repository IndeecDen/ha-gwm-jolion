...
Предупреждения давления шин отображаются для каждого колеса в полной карточке и доступны отдельными бинарными датчиками для автоматизаций. Это статус TPMS автомобиля, а не расчёт по порогу давления; знак «?» означает, что статус недоступен.

Версия **0.1.0-beta.25** · [Изменения](CHANGELOG.md) · [Планы](ROADMAP.md)
