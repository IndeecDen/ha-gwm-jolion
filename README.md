...
Версия **0.1.0-alpha.22** · [Изменения](CHANGELOG.md) · [Планы](ROADMAP.md)
...
- Климат: включение, температура и время работы; обогрев руля и заднего стекла.
...
- наличие обогревов руля, заднего стекла и каждого переднего сиденья.
