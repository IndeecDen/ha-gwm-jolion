...
Версия **0.1.0-beta.17** · [Изменения](CHANGELOG.md) · [Планы](ROADMAP.md)
...
Цвет участка показывает среднюю скорость между соседними GPS-точками: зелёный — до 80 км/ч, жёлтый — 80–110 км/ч, красный — 110 км/ч и выше. Интервалы стоянки и короткого GPS-дрожания не считаются движением и не рисуются цветными линиями. При наведении на участок показывается его средняя скорость; это не мгновенная скорость, поэтому редкий опрос GPS, светофоры и остановки делают оценку приблизительной.

Стоянки продолжительностью не менее 10 минут и смещением не более 30 метров отмечаются отдельной точкой. Стоянка может продолжаться через полночь: в этом случае она объединяется в одну отметку, а начало и окончание относятся к фактическому непрерывному простою. Резкие скачки между GPS-точками считаются потерей связи и не отмечаются как парковка. При наведении показываются время начала и, если автомобиль уже уехал, время окончания. Пока движение после стоянки не записано, строка окончания не показывается.
