...
В правом верхнем углу карты находятся две кнопки: первая возвращает текущее местоположение автомобиля в центр карты, вторая разворачивает карту на весь экран. Повторное нажатие сворачивает её обратно.
