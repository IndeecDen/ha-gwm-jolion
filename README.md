...
Версия **0.1.0-beta.1** · [Изменения](CHANGELOG.md) · [Планы](ROADMAP.md)
...
В разделе климата выберите уровень каждого сиденья и таймер, затем нажмите **«Применить подогрев»**. Мощность 1–3 и таймер задаются ползунками. Переключатель рядом с названием выбирает, включить или выключить сиденье при применении. Показания автомобиля отображаются рядом с настройками.

Анимированная карточка-пульт с автоматической светлой или тёмной темой. В разделе редактора «Кнопки управления» доступен «Подогрев обоих сидений»: уровень 3 на 5 минут, со статусом водительского и пассажирского сидений.
