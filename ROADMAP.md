...
## 0.1.0-alpha.19.3 — текущие полевые уточнения

Этот раздел имеет приоритет над более ранними историческими пунктами ниже, если они противоречат новым физическим тестам.
...
- 🟢 новая карточка показывает locked/unlocked glow, Online/Offline, GSM, компактную строку статусов и анимации дверей, багажника, двигателя и климата;
...
- ✅ `alpha.19.3`: вид сверху, капот слева / багажник справа;
- ✅ изменяемый цвет кузова;
- ✅ `alpha.19.3`: locked/unlocked glow;
- ✅ `alpha.19.3`: Online/Offline + 4-сегментный GSM справа сверху;
- ✅ `alpha.19.3`: нижние компактные статусы engine/climate/fuel/mileage/doors/windows/trunk;
- ✅ `alpha.19.3`: индивидуальные door animations;
- ✅ `alpha.19.3`: trunk / engine / climate animations;
- 🟢 `alpha.19.3`: driver-window animation по `2210001`;
